...
def register_error_handlers(app):
    ...
    def handle_bad_request(error):
        ...
        """
        app.logger.error(f"400 (Bad Request): {error.description}")
    ...
    def handle_unauthorized_user(error):
        ...
        """
        app.logger.error(f"401 (Unauthorized Access): {error.description}")
    ...
    def handle_internal_error(error):
        ...
        """
        app.logger.error(f"500 (Internal Server Error): {error.description}")
